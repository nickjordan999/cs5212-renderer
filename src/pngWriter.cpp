...
void printUsage(const char* programName) {
    ...
    std::cerr << std::endl;
    std::cerr << "  Normal shader mode:" << std::endl;
    std::cerr << "    " << programName << " normalshader <width> <height> <focal_length>" << std::endl;
    std::cerr << "    Visualizes surface normals as RGB colors" << std::endl;
}
